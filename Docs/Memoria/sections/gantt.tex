...
Se ha actualizado la estimación temporal en el apartado \ref{estimaciontemporalfin} con los ajustes mencionados anteriormente, además de la planificación final en el apartado \ref{ganttfinal}, cuya única actualización es la eliminación de la tarea \hyperref[T16]{T16}.
