...
Esta técnica contrasta con otras técnicas como por ejemplo las redes recurrentes ya que estas requieren una ejecución secuencial muy ineficiente y a menudo inestable.
