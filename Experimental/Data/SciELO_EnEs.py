...
class SciELO_EnEs_Dataset():
    ...
    def __init__(self):
        self.url = "https://object.pouta.csc.fi/OPUS-SciELO/v1/tmx/en-es.tmx.gz"
        home = Path.home()
        self.folder = home.joinpath(".cache/lemon/scielo/")
    ...
    def __download_if_required(self):
        ...
        if not os.path.isfile(self.data_filename):
            if not os.path.isfile(self.download_filename):
                print("Downloading SciELO Dataset...")
