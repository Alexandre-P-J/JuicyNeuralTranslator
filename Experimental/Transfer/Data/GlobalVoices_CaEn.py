...
class GlobalVoices_CaEn_Dataset():
    class reader():
    ...
    def __init__(self):
        self.url = "https://object.pouta.csc.fi/OPUS-GlobalVoices/v2018q4/tmx/ca-en.tmx.gz"
        home = Path.home()
        self.folder = home.joinpath(".cache/lemon/globalvoices/")
    ...
    def __download_if_required(self):
        ...
        if not os.path.isfile(self.data_filename):
            if not os.path.isfile(self.download_filename):
                print("Downloading GlobalVoices Dataset...")
