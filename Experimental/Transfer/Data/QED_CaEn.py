...
class QED_CaEn_Dataset():
    ...
    def __init__(self):
        self.url = "https://object.pouta.csc.fi/OPUS-QED/v2.0a/tmx/ca-en.tmx.gz"
        home = Path.home()
        self.folder = home.joinpath(".cache/lemon/qed/")
