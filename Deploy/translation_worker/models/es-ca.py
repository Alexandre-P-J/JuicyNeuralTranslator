...
class EsCa(Model):
    __model = AutoModelForSeq2SeqLM.from_pretrained("Helsinki-NLP/opus-mt-es-ca")
    __tokenizer = AutoTokenizer.from_pretrained("Helsinki-NLP/opus-mt-es-ca")
